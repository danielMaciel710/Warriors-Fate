...
warriorPath:- write('Ficha criada com sucesso').

magePath:- write('Ficha criada com sucesso').

chooseClass(guerreiro):- warriorPath.
chooseClass(mago):- magePath.
chooseClass(_):-  write('Classe inválida').
...
startGame:-
	text('Há muito tempo atrás numa terra distante, existia uma lenda: Bravos guerreiros em um momento específico de sua jornada eram atraídos para uma misteriosa caverna, esta que prometia à aqueles que superassem seus desafios um imenso poder...'),
	continuar,
